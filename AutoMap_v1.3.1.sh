    ...
    do
        ...
        if [ "$genome" == "hg19" ]; then
            ...
            if [ ! -f "$rep" ]; then
                ...
                bash $here/Resources/merge_repeats.sh $out/Resources/repeats.part1.bed.gz $out/Resources/repeats.part2.bed.gz $rep
            fi
        fi
        if [ "$genome" == "hg38" ]; then
            mkdir $out/Resources/
            ...
            if [ ! -f "$rep" ]; then
                ...
                bash $here/Resources/merge_repeats.sh $out/Resources/repeats_hg38.part1.bed.gz $out/Resources/repeats_hg38.part2.bed.gz $rep
            fi
        fi
